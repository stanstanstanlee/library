<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        ...
        <body>
            <h3>책 정보 관리</h3>
            <a href="addBookPage">도서 등록</a><br><br><br>

            <p>도서 목록</p>

            <form action="bookPage" method="post" id="searchForm">
                ...
                <input type="text" id="searchText" name="searchText" placeholder="책제목, 저자, ISBN 중 검색">
                <button type="submit">검색</button>
            </form>
            
           

            <form action="bookPage" method="get" id="allBooksForm">
                <button type="submit">전체목록조회</button>
            </form>

            <form action="goToStockSearchPage" method="get">
                <button type="submit">재고탐색</button>
            </form>

            <br>
            <br>
            <button onclick="deleteSelectedBooks()">일괄 삭제</button>
            <button onclick="uncheckAllBooks()">일괄선택취소</button>
            <table>
                <thead>
                    <tr>
                        <th>선택</th>
                ...
                <tbody>
                    <c:forEach var="book" items="${bList}">
                        ...
                        <tr>
                            <td><input type="checkbox" class="bookCheckbox" value="${book.bookNum}" /></td>
                            <td onclick="navigateToDetail('${book.bookNum}', '${book.bookRegisterDate}')">
                                ${book.bookNum}</td>
