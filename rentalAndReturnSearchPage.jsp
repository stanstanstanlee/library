<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        ...
        <body>
            <h3>대여 및 반납 정보 관리</h3>
            <a href="returnHistorySearchPage">반납 내역 확인 하러 가기</a><br><br><br>

            <p>대여 내역</p>

            <form action="rentalAndReturnSearchPage" method="post" id="searchForm">
                <label for="searchDate">대여일:</label>
                ...
                <br>
                <label for="searchText">대여자 ID:</label>
                <input type="text" id="searchText" name="searchText" placeholder="대여자 ID로 검색">
                <button type="submit">검색</button>
            </form>
            
           

            <form action="rentalAndReturnSearchPage" method="get">
                <button type="submit">전체목록조회</button>
            </form> 
            <br>
            <form action="rentalsNotReturned" method="get">
                <button type="submit">미반납 대여 목록</button>
            </form>
            <br>
