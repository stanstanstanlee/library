<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        ...
        <body>
            <h3>반납할 때 점검한 이력</h3>
            <a href="gotoReturnConditionSettingDetailPage">뒤로가기</a><br><br><br>

            <p>반납 점검 이력</p>

            <form action="returnConditionHistoryPage" method="post" id="searchForm">
                ...
                <br>
                <label for="searchText">반납자ID 혹은 재고번호 : </label>
                <input type="text" id="searchText" name="searchText" placeholder="반납자ID 혹은 재고번호">
                <button type="submit">검색</button>
            </form>

            <form action="returnConditionHistoryPage" method="get">
                <button type="submit">전체 반납 점검 이력조회</button>
            </form>
                        ...
                        <tbody id="bookTableBody">
                            <c:forEach var="book" items="${bookList}">
                                <tr class='<c:if test="${book.overDue}">overDue</c:if>'>
                                    ...
                                    <td>
                                            <c:forEach var="condition" items="${rConditionDTOList}" varStatus="status">
