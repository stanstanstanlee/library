                    ...
                    <table id="bookTable" style="border: 1px solid black;">
                        <thead>
                            <tr>
                                <th>대여자 </th>
                                <th>대여 번호</th>
                                <th class="rentalDateYellow">대여한 날짜</th>
                        ...
                        <tbody id="bookTableBody">
                            <c:forEach var="book" items="${bookList}">
                                <tr class='<c:if test="${book.overDue}">overDue</c:if>' >
                                    ...
                                    <td class="leftOverDueDays">${book.leftOverDueDays}</td>
                                    <td>${book.bookNum}</td>
        ...
        <script>
            $(document).ready(function () {
                $("#cancelButton").click(function () {
                    window.location.href = "goToOverdueBooksPage"; // rentBookPage에 대한 URL로 이동
                });
            });
            </script>
        </html>